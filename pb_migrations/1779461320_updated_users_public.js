...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_ub7o")

  // remove field
  collection.fields.removeById("_clone_rwxC")

  // remove field
  collection.fields.removeById("_clone_vSJM")

  // remove field
  collection.fields.removeById("_clone_Ivkd")

  // remove field
  collection.fields.removeById("_clone_hldK")

  // remove field
  collection.fields.removeById("_clone_xFN4")

  // remove field
  collection.fields.removeById("_clone_xD0H")

  // remove field
  collection.fields.removeById("_clone_xZbC")

  // remove field
  collection.fields.removeById("_clone_LWGa")

  // remove field
  collection.fields.removeById("_clone_JPa1")
